...
const getRandomImage = () => PLACEHOLDER_IMAGES[Math.floor(Math.random() * PLACEHOLDER_IMAGES.length)];
...
const HealthNewsCards = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-16">
            {loading && <p className="text-center text-lg font-semibold">Loading news...</p>}
